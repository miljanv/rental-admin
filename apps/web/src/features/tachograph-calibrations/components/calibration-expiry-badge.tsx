...
import { formatExpiryLabel } from '@/features/tachograph-calibrations/lib/calibration';
...
interface CalibrationExpiryBadgeProps {
  expiresAt: string;
  todayIso: string;
}

export function CalibrationExpiryBadge({ expiresAt, todayIso }: CalibrationExpiryBadgeProps) {
