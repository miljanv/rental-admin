...
import { formatExpiryLabel } from '@/features/vehicle-safety-equipment/lib/safety-equipment';
...
interface SafetyEquipmentExpiryBadgeProps {
  expiresAt: string;
  todayIso: string;
}

export function SafetyEquipmentExpiryBadge({ expiresAt, todayIso }: SafetyEquipmentExpiryBadgeProps) {
