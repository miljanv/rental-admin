...
export const toDocumentFormValues = (document: DriverDocumentDto): DriverDocumentWriteInput => ({
  type: document.type,
  documentNumber: document.documentNumber,
  issuedAt: document.issuedAt,
  expiresAt: document.expiresAt ?? '',
  employmentContractType: document.employmentContractType ?? '',
